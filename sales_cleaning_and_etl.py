...
if __name__ == "__main__":
    ...
    os.makedirs("C:\\Users\\yadav\\Data_Analyst_Resume_Package\\GitHub_Portfolio_Assets\\Project_1_Sales_Analytics", exist_ok=True)

    # Run Generation
    raw_sales = generate_messy_sales_data(1000)
    # Save raw data for reference
    raw_sales.to_csv("C:\\Users\\yadav\\Data_Analyst_Resume_Package\\GitHub_Portfolio_Assets\\Project_1_Sales_Analytics\\raw_uncleaned_sales.csv", index=False)
    print("Simulated raw dataset saved: 'raw_uncleaned_sales.csv'")

    # Run Cleaning
    cleaned_sales = clean_sales_data(raw_sales)
    # Save clean, structured data
    cleaned_sales.to_csv("C:\\Users\\yadav\\Data_Analyst_Resume_Package\\GitHub_Portfolio_Assets\\Project_1_Sales_Analytics\\cleaned_sales_dataset.csv", index=False)
    print("Cleaned, production-ready dataset saved: 'cleaned_sales_dataset.csv'\n")
